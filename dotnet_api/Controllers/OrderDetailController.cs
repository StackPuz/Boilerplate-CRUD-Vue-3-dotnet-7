...
namespace App.Controllers
{
    ...
    public class OrderDetailController : Controller
    {
        ...
        [HttpPost("")]
        public async Task<IActionResult> Create([FromBody] ViewModel.Create.OrderDetail model)
        {
        ...
        public async Task<IActionResult> Edit(int? orderId, short? no)
        {
            ...
            return Ok(new { orderDetail, products });
        }

        [HttpPut("{orderId}/{no}")]
        public async Task<IActionResult> Edit(int orderId, short no, [FromBody] ViewModel.Edit.OrderDetail model)
        {
            if (ModelState.IsValid)
            {
                try
