          ...
          <table class="table table-sm table-striped table-hover">
            <thead>
              <tr>
                ...
                <th :class="getSortClass('BrandName') + ' d-none d-md-table-cell'">
                  <router-link :to="getLink('sort','BrandName')">Brand</router-link>
                </th>
                <th :class="getSortClass('UserAccountName') + ' d-none d-md-table-cell'">
                  <router-link :to="getLink('sort','UserAccountName')">Create User</router-link>
                </th>
                <th>Actions</th>
              </tr>
            </thead>
            <tbody>
              <tr v-for="product in products" :key="product">
                ...
                <td class="d-none d-md-table-cell text-center"><a v-if="product.Image" :href="`http://localhost:5000/uploads/products/${product.Image}`" target="_blank" :title="`${product.Image}`"><img class="img-list" :src="`http://localhost:5000/uploads/products/${product.Image}`" /></a></td>
                <td>{{product.Name}}</td>
